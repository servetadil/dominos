...
{
    public partial class Repository<T> : IDisposable,
        IRepository<T> where T : BaseEntity
    {
        ...
        {
            return await this.Entities.FirstOrDefaultAsync(o => o.Id == id);
        }
        ...
        {
            return this._context.ExecuteStoredProcedureList<TEntity>(commandText, parameters);
        }
